...
@Mapper(uses = { ExternalReferenceMapper.class, HashMapper.class, LicenseChoiceMapper.class, PropertyMapper.class, OrganizationalEntityMapper.class })
public interface ComponentMapper extends DescriptorMapper<Component, ComponentDescriptor> {
    ...
    @BeanMapping(ignoreUnmappedSourceProperties = { "swid", "pedigree", "evidence", "releaseNotes", "modelCard", "data", "any", "otherAttributes" })
