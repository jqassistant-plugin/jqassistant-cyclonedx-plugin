...
@Label("SBOM")
public interface SBOMDescriptor extends CycloneDXDescriptor, ContainsComponentsTemplate, HasExternalReferencesTemplate, HasPropertiesTemplate, VersionTemplate {
